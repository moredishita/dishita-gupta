...
#         else:
#             print("Database missing, creating new one...")
#     except:
...
#     def main_menu(self):
#         self.clear()
#         tk.Label(self.root, text="Bank Management System", font=("Arial", 18)).pack(pady=20)

#         tk.Button(self.root, text="Create Account", width=25, command=self.create_account).pack(pady=5)
#         tk.Button(self.root, text="Deposit Money", width=25, command=self.deposit).pack(pady=5)
#         tk.Button(self.root, text="Withdraw Money", width=25, command=self.withdraw).pack(pady=5)
#         tk.Button(self.root, text="View Details", width=25, command=self.details).pack(pady=5)
#         tk.Button(self.root, text="Update Details", width=25, command=self.update_details).pack(pady=5)
#         tk.Button(self.root, text="Delete Account", width=25, command=self.delete_account).pack(pady=5)
...
#         entries = {}
#         fields = ["Name", "Email", "Phone", "PIN (4 digits)"]
#         for f in fields:
...
#         return [i for i in Bank.data if i['account no.'] == acc and i['pin'] == pin]
...
#         def submit():
#             user = self.find_user(acc_entry.get(), int(pin_entry.get()))
#             if not user:
...
#     def details(self):
#         self.clear()
#         tk.Label(self.root, text="Account Details", font=("Arial", 18)).pack(pady=10)
...
#         self.clear()
#         tk.Label(self.root, text="Update Details", font=("Arial", 18)).pack(pady=10)
...
#             self.clear()
#             tk.Label(self.root, text="Update Fields (Leave blank to skip)").pack(pady=10)

#             name = tk.Entry(self.root)
#             email = tk.Entry(self.root)
#             phone = tk.Entry(self.root)
#             pin_new = tk.Entry(self.root)

#             for label, entry in [("Name", name), ("Email", email), ("Phone", phone), ("PIN", pin_new)]:
#                 tk.Label(self.root, text=label).pack()
#                 entry.pack()

#             def submit_update():
#                 new_data = {
#                     "name": name.get() or user[0]["name"],
#                     "email": email.get() or user[0]["email"],
#                     "phoneno": phone.get() or user[0]["phoneno"],
#                     "pin": int(pin_new.get()) if pin_new.get() else user[0]["pin"],
#                     "account no.": user[0]["account no."],
#                     "balance": user[0]["balance"]
#                 }

#                 user[0].update(new_data)
#                 Bank._update()
#                 messagebox.showinfo("Success", "Details Updated")
#                 self.main_menu()

#             tk.Button(self.root, text="Submit", command=submit_update).pack(pady=10)
#             tk.Button(self.root, text="Back", command=self.main_menu).pack()

#         tk.Button(self.root, text="Next", command=next_step).pack(pady=10)
#         tk.Button(self.root, text="Back", command=self.main_menu).pack()

#     # ---------- Delete ----------
#     def delete_account(self):
#         self.clear()
#         tk.Label(self.root, text="Delete Account", font=("Arial", 18)).pack(pady=10)
...
# git config --global user.email "dishitagupta2009@gmail.com"
# git config --global user.name "dishita gupta"
